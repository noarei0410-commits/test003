...
function loadDeckByTitle(title) {
    ...
    selectedSleeve = data.sleeve || 0;
    // UI反映
    const radio = document.querySelector(`input[name="sleeve"][value="${selectedSleeve}"]`);
...
function updateSleevePreview(val) {
    selectedSleeve = parseInt(val);
}
